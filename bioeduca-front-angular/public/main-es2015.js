...
AvaliacaoService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let PendenciaService = class PendenciaService {
    constructor(http) {
        this.http = http;
        this.URL = 'https://crtcc.herokuapp.com/';
    }
...
PendenciaService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
QuestoesService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
let SugestaoService = class SugestaoService {
    constructor(http) {
        this.http = http;
        this.URL = 'https://crtcc.herokuapp.com/';
    }
...
SugestaoService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"] }
];
...
/* harmony import */ var ng_starrating__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ng-starrating */ "./node_modules/ng-starrating/fesm2015/ng-starrating.js");
...
let AvaliacaoComponent = class AvaliacaoComponent {
    constructor(_avaliacaoService, _questoesService, _sugestaoService, formBuilder, authenticationService, route, _pendencia) {
...
AvaliacaoComponent.ctorParameters = () => [
...
let AnoLetivoComponent = class AnoLetivoComponent {
    constructor() {
        this.anos = ["2019", "2019"];
    }
    ngOnInit() {
...
let ConteudoComponent = class ConteudoComponent {
    constructor() {
...
let HomeComponent = class HomeComponent {
    constructor(userService, sugestServ) {
...
let InicialComponent = class InicialComponent {
    constructor(sugestServ, formBuilder) {
        this.sugestServ = sugestServ;
        this.formBuilder = formBuilder;
    }
    getSistema() {
...
InicialComponent.ctorParameters = () => [
...
let PendenciaComponent = class PendenciaComponent {
    constructor(_pendenciaService, authenticationService) {
...
PendenciaComponent.ctorParameters = () => [
...
QuestoesComponent.ctorParameters = () => [
    { type: _app_services_questoes_service__WEBPACK_IMPORTED_MODULE_2__["QuestoesService"] }
];
...
let SoftwareAlterarComponent = class SoftwareAlterarComponent {
    constructor(fb, cd, authenticationService, sugestServ, formBuilder, route) {
        this.fb = fb;
        this.cd = cd;
        this.authenticationService = authenticationService;
        this.sugestServ = sugestServ;
...
SoftwareAlterarComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
...
let SoftwareCadastrarComponent = class SoftwareCadastrarComponent {
    constructor(fb, cd, authenticationService, sugestServ, formBuilder) {
        this.fb = fb;
        this.cd = cd;
        this.authenticationService = authenticationService;
        this.sugestServ = sugestServ;
...
SoftwareCadastrarComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormBuilder"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] },
    { type: _app_services__WEBPACK_IMPORTED_MODULE_4__["AuthenticationService"] },
    { type: _app_services_sugestao_service__WEBPACK_IMPORTED_MODULE_2__["SugestaoService"] },
...
let SoftwareConsultarComponent = class SoftwareConsultarComponent {
    constructor(sugestServ, route, _avaliacaoService, _authenticationService, _pendenciaService) {
        this.sugestServ = sugestServ;
        this.route = route;
        this._avaliacaoService = _avaliacaoService;
    ...
    exibeLInks(userId) {
        ...
        this._pendenciaService.getByUser(userId)
            .subscribe(p => {
            this.pendencia = p;
            console.log('pendencia.data', this.pendencia.data.length);
            if (this.pendencia.data.length > 0) {
...
SoftwareConsultarComponent.ctorParameters = () => [
    { type: _app_services_sugestao_service__WEBPACK_IMPORTED_MODULE_2__["SugestaoService"] },
...
let SoftwareMeusSugeridosComponent = class SoftwareMeusSugeridosComponent {
    constructor(sugestServ, authenticationService) {
        this.sugestServ = sugestServ;
        this.authenticationService = authenticationService;
    }
    getIndicatios(id) {
...
SoftwareMeusSugeridosComponent.ctorParameters = () => [
...
let UsuarioAlterarComponent = class UsuarioAlterarComponent {
    constructor(formBuilder, route, router, userServ, authenticationService) {
        this.formBuilder = formBuilder;
        this.route = route;
        this.router = router;
...
UsuarioAlterarComponent.ctorParameters = () => [
...
let UsuarioCadastrarComponent = class UsuarioCadastrarComponent {
    constructor(formBuilder, route, router, userServ) {
        this.formBuilder = formBuilder;
        this.route = route;
        this.router = router;
        this.userServ = userServ;
...
UsuarioCadastrarComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
    { type: _app_services__WEBPACK_IMPORTED_MODULE_4__["UserService"] }
...
let UsuarioConsultarComponent = class UsuarioConsultarComponent {
    constructor(authenticationService) {
        this.authenticationService = authenticationService;
        this.authenticationService.currentUser.subscribe(x => this.currentUser = x);
    }
...
UsuarioConsultarComponent.ctorParameters = () => [
    { type: _app_services__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"] }
];
...
let UsuarioExcluirComponent = class UsuarioExcluirComponent {
    constructor() { }
    ngOnInit() {
    }
};
